...
// 路由懒加载
const MyRecommend = () => import(/* webpackChunkName: 'myRecommend' */'@/components/MyRecommend/MyRecommend')

const MySinger = () => import(/* webpackChunkName: 'mySinger' */'@/components/MySinger/MySinger')
